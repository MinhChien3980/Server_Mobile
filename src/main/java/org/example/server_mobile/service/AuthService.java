...
import org.example.server_mobile.dto.request.LogoutRequest;
import org.example.server_mobile.dto.request.RefreshRequest;
...
public class AuthService {
    ...
    public void logout(LogoutRequest request) throws ParseException, JOSEException {
        try {
            ...
            InvalidatedToken invalidatedToken =
                    InvalidatedToken.builder().id(Long.valueOf(jit)).expiryTime(expiryTime).build();
    ...
    public AuthResponse refreshToken(RefreshRequest request) throws ParseException, JOSEException {
        ...
        var user =
                userRepository.findByEmail(userEmail).orElseThrow(() -> new AppException(ErrorCode.UNAUTHENTICATED));
